//*************************************
//	 Library for CS43L22 extracted from:
...
//
//	 (MODIFIED TO SUPPORT DMA BY Franco Caspe)
//*************************************

#include "cs43l22.h"

void cs43l22_phy_startup()
{
	...
	// I2S pins (MCK = PC7, SCK = PC10, SD = PC12, WS = PA4)
	PinInitStruct.GPIO_OType = GPIO_OType_PP;
